...
public ValidateCar (marca, modelo, matricula, color, combustible, fumar, mascotas, tiempo){
  if(marca == this.marca && modelo == this.modelo && matricula == this.matricula && color == this.color && combustible == this.combustible && fumar == this.fumar && mascotas == this.mascotas && tiempo == this.tiempo){
